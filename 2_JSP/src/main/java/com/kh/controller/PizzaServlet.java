 ...
 * http://localhost:8888/jsp/confirmPizza.do
 */
...
//		System.out.println("pizza주문 도착");
		...
		//1) 인코딩처리 => 전달값 중 한글이 있을 수 있다. (post일때만 / get일 때 해도 상관없음)
		...
		// 넘겨받은 값을 꺼내보자
		String name = request.getParameter("userName"); // "구현서"
		String phone = request.getParameter("phone"); // "010xxxxxxxx"
		String address = request.getParameter("address"); // "경기도 ㅇㅇㅇ"
		String message = request.getParameter("message"); // 냉큼오게나~
		
		String pizza = request.getParameter("pizza"); // 게살피자
		String[] toppings = request.getParameterValues("toppings"); // ["게살피자"]

<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="java.util.Date, java.text.SimpleDateFormat" %>
        ...
        <body>
            ...
            <h2>오늘의 날짜</h2>
            <% Date today=new Date(); SimpleDateFormat sdf=new SimpleDateFormat("yyyy년 MM월 dd일"); // yyyy년 MM월 dd일 %>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <input type="checkbox" name="toppings" value="치즈추가"> 치즈추가
                                    <input type="checkbox" name="toppings" value="베이컨/소세지"> 베이컨/소세지
                                    <input type="checkbox" name="toppings" value="파인애플"> 파인애플
                                </td>
                            </tr>
                            <tr>
                                <th>사이드</th>
